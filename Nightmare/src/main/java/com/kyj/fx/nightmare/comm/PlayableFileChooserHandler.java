 ...
 *
 */
public class PlayableFileChooserHandler implements Consumer<FileChooser> {

	private String title = "";

	public PlayableFileChooserHandler(String title) {
		super();
		this.title = title;
	}

	public PlayableFileChooserHandler() {
		super();
	}
	...
	public void accept(FileChooser option) {
		...
		option.getExtensionFilters().add(new ExtensionFilter("Wav files (*.wav)", "*.wav"));
