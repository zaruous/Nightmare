...
public class ResponseModelDVO {
	...
	public class Choice {
		...
		public String toString() {
			return "Choice [index=" + index + ", message=" + message + ", logprobs=" + logprobs + ", finish_reason=" + finish_reason + "]";
		}
	...
	@Override
	public String toString() {
		return "ResponseModelDVO [id=" + id + ", object=" + object + ", created=" + created + ", model=" + model + ", choices=" + choices
				+ ", usage=" + usage + ", system_fingerprint=" + system_fingerprint + "]";
	}
